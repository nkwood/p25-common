  ...
  public static System buildSystem() {
    return new System(
        "sys00", 0, 111111, Arrays.asList(
          new Site("site00", 0, 1, 37.807143d, -122.261150d, Arrays.asList(222.22222, 333.33333)),
          new Site("site01", 1, 2, 22.208335d, -159.507002d, Arrays.asList(333.33333, 444.44444))
    ), Arrays.asList(
    ...
    return Arrays.asList(
        ...
        new System(
            "sys01", 1, 222222, Arrays.asList(
              new Site("site02", 2, 3, 52.475422d, 13.412440d, Arrays.asList(444.44444, 555.55555))
            ),
